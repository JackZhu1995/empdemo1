                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="name" onblur="confirmName();" />
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="salary" onblur="confirmSalary();" />
                            <scan id="confirmSalary"></scan>
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="job" onblur="confirmJob();" />
